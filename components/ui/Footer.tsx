        ...
        <footer className="bg-[#050505] border-t border-neutral-900 text-neutral-400 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-white tracking-widest uppercase">Seranex</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-neutral-900 text-center text-xs text-neutral-600">
