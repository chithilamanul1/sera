...
const themes = [
  { name: 'Cyber Blue', primary: '#3b82f6', accent: '#06b6d4' }, // Default
...
export default function ThemeSwitcher() {
  ...
  // Function to update CSS Variables globally
  const changeTheme = (theme) => {
    ...
    // Trigger Ripple Animation (Optional visual feedback)
  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed top-24 right-0 z-50 bg-black/80 backdrop-blur border-y border-l border-gray-700 p-3 rounded-l-xl shadow-2xl hover:border-primary transition-colors group"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed top-24 right-16 z-50 bg-black/90 backdrop-blur border border-gray-700 p-4 rounded-xl shadow-2xl w-48"
          >
            ...
            <div className="grid grid-cols-1 gap-2">
              {themes.map((theme) => (
                ...
                >
                  <div 
                    className="w-6 h-6 rounded-full border border-gray-600 shadow-[0_0_10px_inset_rgba(0,0,0,0.5)]" 
