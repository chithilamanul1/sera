    ...
    <footer className="bg-surface border-t border-gray-800 pt-16 pb-8 mt-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h3 className="font-bold text-white mb-6 uppercase tracking-wider text-sm">Contact Engineering</h3>
            <ul className="space-y-3 text-gray-400 text-sm">
              <li><a href="tel:0724139621" className="hover:text-primary transition-colors text-white font-bold text-lg">072 413 9621</a></li>
              <li><a href="tel:0728382638" className="hover:text-primary transition-colors text-white font-bold text-lg">072 838 2638</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs font-mono text-gray-600 gap-4">
          ...
          <div className="flex items-center gap-6">
             <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-green-500 rounded-full"></div><span>LATENCY: 24ms</span></div>
             <div className="hidden md:block w-px h-4 bg-gray-800"></div>
             <div>SEEDUWA TIME: <span className="text-primary">{time}</span></div>
             <div className="hidden md:block w-px h-4 bg-gray-800"></div>
             <div className="flex items-center gap-2"><span className="border border-gray-700 px-1 rounded text-[10px]">CTRL+K</span><span>TO NAVIGATE</span></div>
          </div>
        </div>
      </div>
    </footer>
